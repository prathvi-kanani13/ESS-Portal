...
export function Header() {
  ...
  return (
    <div className="bg-white sticky top-0 z-10 w-full">
      <div className="hidden md:flex items-center w-full px-12 py-4">
        {isDashboard && (
        ...
        <div className="flex items-center gap-6 h-[80px] justify-end ml-auto">
          ...
          <div className="flex w-96 items-center">
            <Input
              ...
              className="h-10 flex-1 rounded-r-none border-r-0 border-gray-300 focus-visible:ring-0 focus-visible:ring-offset-0 placeholder:text-[15px] placeholder:text-[#C4C4C4]"
            />
        ...
        <div className="flex items-center gap-8 ml-6 h-[80px]">
                ...
                notifications.map((n) => (
                  ...
                  >
                    <div className="flex justify-between w-full items-start">
                      <p className="font-medium text-md text-[#0A0A0A]">
                        {n.title}
                      </p>
                      <button
                        onClick={(e) => {
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent
              ...
              align="end"
            >
              <DropdownMenuItem className="w-full py-2 justify-center text-[#8F8F8F] text-base font-medium hover:bg-gray-100">
                Profile
              </DropdownMenuItem>
